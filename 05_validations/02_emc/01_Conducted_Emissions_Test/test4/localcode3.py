...
def show_figure_pair_with_captionsOLD(fig_counter, img1, caption1, img2=None, caption2=None, first_part_path=None):
    ...
    if img2 is not None:
        ...
        <div    style="display: flex; justify-content: center; align-items: center; width: 100%; gap: 1cm;">
...
def show_figure_pair_with_captions(fig_counter, img1, caption1, img2=None, caption2=None, first_part_path=None):
    ...
    if img2 is not None:
        img2 = first_part_path + img2
        html = f"""
        <div style="display: flex; justify-content: center; align-items: stretch; width: 100%; gap: 1cm;">
