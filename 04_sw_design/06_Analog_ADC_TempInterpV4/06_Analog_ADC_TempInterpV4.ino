...
void loop() {
  ...
  Serial.print(power_derating); Serial.print(' ');
    ...
    float Iout = 0.016064*(adc_read(0)-412) ; //se excel file 
    float Iin = 0.002008*(adc_read(5)-197) ; //se excel file 
    Serial.print( Iout); Serial.print(' ');
    Serial.print( Iin); Serial.print(' ');
