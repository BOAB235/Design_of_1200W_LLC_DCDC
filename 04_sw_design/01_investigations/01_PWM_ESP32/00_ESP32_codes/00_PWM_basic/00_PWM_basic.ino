...
float dutyCycleA = 50; // Set duty cycle for Timer 0 in %
//float dutyCycleB = 25; // Set duty cycle for Timer 1 %
// not working, in complimentary i must give only one duty cycle 
// the other is calculated as 100% - first DD - dead time 
...
void loop() { 
} // Empty loop since PWM runs independently
