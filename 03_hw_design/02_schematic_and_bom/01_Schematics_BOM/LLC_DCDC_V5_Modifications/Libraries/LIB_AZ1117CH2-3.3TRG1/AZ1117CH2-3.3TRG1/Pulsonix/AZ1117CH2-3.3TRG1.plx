...
//778457/1753220/2.50/4/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AZ1117CH2-3.3TRG1" (originalName "AZ1117CH2-3.3TRG1")
	...
	(compDef "AZ1117CH2-3.3TRG1" (originalName "AZ1117CH2-3.3TRG1") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AZ1117CH2-3.3TRG1"))
		...
		(attr "Mouser Part Number" "621-AZ1117CH2-33TRG1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AZ1117CH2-3.3TRG1?qs=lQAVKuKFhkLc7jCxso2G3w%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AZ1117CH2-3.3TRG1")
		(attr "Description" "LDO Voltage Regulators LDO BJT HiCurr SOT223 T&R 4K")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AZ1117C.pdf")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "AZ1117CH2-3.3TRG1.stp")
