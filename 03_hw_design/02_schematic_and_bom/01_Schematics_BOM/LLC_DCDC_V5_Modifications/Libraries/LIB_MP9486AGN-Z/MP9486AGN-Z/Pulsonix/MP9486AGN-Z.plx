...
//1190001/1753220/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MP9486AGN-Z" (originalName "MP9486AGN-Z")
	...
	(compDef "MP9486AGN-Z" (originalName "MP9486AGN-Z") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "BST") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "EP") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "EN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "DIM") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SW") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MP9486AGN-Z"))
		...
		(attr "Mouser Part Number" "946-MP9486AGN-Z")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Monolithic-Power-Systems-MPS/MP9486AGN-Z?qs=YCa%2FAAYMW010ws20lFESXg%3D%3D")
		(attr "Manufacturer_Name" "Monolithic Power Systems (MPS)")
		(attr "Manufacturer_Part_Number" "MP9486AGN-Z")
		(attr "Description" "Switching Voltage Regulators 100V Input, 3.5A, Switching Current Limit Step-Down Converter")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/MP9486AGN-Z.pdf")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "MP9486AGN-Z.stp")
